...
const ClientProofSection: React.FC = () => {
  const proofs = [
    ...
    },
    {
      ...
      description: 'Custom-engineered technical onboarding workflow and user management.',
      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="flex flex-col lg:flex-row justify-between items-end mb-16 gap-8">
          <div className="max-w-2xl">
            <span className="inline-block bg-blue-600 text-white text-[10px] font-black uppercase tracking-[0.3em] px-4 py-1.5 rounded-full mb-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          {/* Trust CTA Card */}
          <div className="bg-slate-900 rounded-[40px] p-8 text-white flex flex-col justify-center items-center text-center relative overflow-hidden group">
