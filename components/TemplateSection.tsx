    ...
    <section className="py-24 bg-white">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="text-center mt-20">
          <a href="#" className="text-slate-900 font-black text-sm uppercase tracking-widest border-b-2 border-slate-900 pb-2 hover:text-blue-600 hover:border-blue-600 transition-all">
