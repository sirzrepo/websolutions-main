    ...
    <section className="py-32 bg-[#fafafa] relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="text-center mb-24">
          <span className="inline-block bg-blue-600/10 text-blue-600 font-black text-[10px] uppercase tracking-[0.4em] px-4 py-2 rounded-full mb-6">
            Real Deployment Preview
          </span>
          <h2 className="text-5xl md:text-8xl font-black text-slate-900 leading-[0.9] tracking-tighter mb-8">
            Experience the <br/>SIRZ standard.
          </h2>
          <p className="text-xl text-slate-500 max-w-2xl mx-auto font-medium">
            We don't just build websites; we craft conversion-focused mobile experiences that mirror the biggest brands in the world.
          </p>
        </div>
            ...
            <div className="relative mx-auto w-[310px] h-[640px] bg-[#1a1a1a] rounded-[54px] border-[10px] border-[#2a2a2a] shadow-[0_60px_120px_-30px_rgba(0,0,0,0.4)] overflow-hidden transition-all duration-700 group-hover:-translate-y-4">
              ...
              <div className="h-full bg-white pt-10 overflow-y-auto hide-scrollbar">
                ...
                <div className="sticky bottom-0 bg-white p-6 border-t border-slate-50">
                  <button className="w-full bg-[#007aff] text-white py-4 rounded-xl font-black text-[12px] shadow-lg shadow-blue-500/20">Pay</button>
                </div>
              </div>
            </div>
            ...
            <div className="relative mx-auto w-[310px] h-[640px] bg-[#1a1a1a] rounded-[54px] border-[10px] border-[#2a2a2a] shadow-[0_60px_120px_-30px_rgba(0,0,0,0.4)] overflow-hidden transition-all duration-700 group-hover:-translate-y-4">
              ...
              <div className="h-full bg-white flex flex-col">
                ...
                <div className="p-6 bg-slate-50 border-t border-slate-100">
                  ...
                  <button className="w-full bg-[#e2b041] text-white py-4 rounded-xl font-black text-[12px] flex items-center justify-center gap-2 shadow-xl shadow-[#e2b041]/20">
        ...
        {/* Closing trust bridge */}
        <div className="mt-32 bg-slate-900 rounded-[54px] p-12 text-white relative overflow-hidden group">
